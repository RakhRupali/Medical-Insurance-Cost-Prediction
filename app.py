...
# --- EDA PAGE ---
    ...
    # ✅ FIX 1: Q6 string now matches the selectbox exactly
    elif eda_q == "Q6:-How do charges vary with age?":
        ...
        st.plotly_chart(fig)
        st.write(df.nlargest(5, 'charges'))
...
# --- PREDICTION PAGE ---
    ...
    if st.button("Predict Insurance Cost..."):
        ...
        # ✅ FIX 2: "Female"/"Male" now matches selectbox (capital letters)
        sex_val = 1 if gender == "Male" else 0

        # ✅ FIX 3: "Yes"/"No" now matches selectbox (capital letters)
...
# --- ABOUT ME PAGE ---
    ...
    * **LinkedIn:** [Rupali Kendre](https://www.linkedin.com/in/rupali-kendre-1680b3386/)
    * **GitHub:**
